...
To install Spotify Integration Server for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@boristopalov/spotify-mcp):

```bash
npx -y @smithery/cli install @boristopalov/spotify-mcp --client claude
```
